...
import { formatConfidence, formatDate, formatMinorSek, formatQuantity, formatSek } from "./lib/format.ts";
import { getStripeConfig } from "./lib/runtimeConfig.ts";
import { getSupabaseClient } from "./lib/supabaseClient.ts";
import { EDGE_FUNCTIONS, callEdgeFunction } from "./api/functions.ts";
import {
  completeAppProfile,
  getAuthSnapshot,
  initAuthState,
...
function csvImportMeta(row) {
  ...
  return {
    ...
    fileName: String(csvImport.fileName || raw.fileName || nestedRaw.fileName || "CSV file"),
