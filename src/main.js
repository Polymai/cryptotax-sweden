...
const uiText = {
  ...
  sv: {
    ...
    signIn: "Logga in",
    signedIn: "Inloggad",
    secureSignIn: "S�ker Supabase-inloggning f�r sparade arbetsytor",
    taxYear: "Inkomst�r",
    readyForDiscovery: "Redo f�r kontroll",
    ready: "Redo",
    connectBinance: "Anslut Binance Tax API-nyckel f�r att b�rja",
    taxableResult: "Ber�knat skattepliktigt resultat fr�n nuvarande transaktioner",
    language: "Spr�k",
    displayName: "Visningsnamn",
    active: "Aktivt",
    signedInAs: "Inloggad som",
    supabaseUser: "Supabase-anv�ndare",
    useUsdPeg: "Anv�nd USD-peg f�r stablecoin-anskaffningsv�rde",
    useUsdPegHelp: "USDT, USDC, FDUSD och DAI anv�nder USD/SEK p� transaktionsdatum som fallback n�r k�phistorik saknas.",
    calculationSettings: "Inst�llningar f�r skatteber�kning",
    calculationSettingsHelp: "Standardval som anv�nds n�r appen priss�tter och ber�knar importerade transaktioner.",
    saveProfile: "Spara profil",
    profileTrust: "Inloggning hanteras s�kert av Supabase. Om du har anv�nt en annan tj�nst fr�n samma leverant�r kan samma konto fungera h�r.",
    signOut: "Logga ut",
    uploadedSlotsTitle: "Uppladdade transaktioner / k�pta transaktionsplatser",
    inYear: "under",
    generated: "Genererad",
    draft: "Utkast",
    rows: "rader",
    ...
    k4Report: "K4-rapport",
    k4ReportHelp: "Skapa ett K4-underlag f�r avsnitt D till Skatteverket och h�ll inkomstrader separat.",
    k4SectionRows: "K4 avsnitt D-rader",
    k4Profit: "K4-vinst",
    k4Loss: "K4-f�rlust",
    otherIncome: "�vrig inkomst",
    generateReport: "Generera rapport",
    saveK4Pdf: "Spara K4 PDF",
    downloadK4Csv: "Ladda ner K4 CSV",
    auditExplanation: "Revisionsf�rklaring",
    auditExplanationHelp: "Kopiera detta till egna granskningsanteckningar eller underlag till redovisningshj�lp.",
    digitalFilingNote: "Notering om digital inl�mning",
    digitalFilingHelp: "Skatteverkets digitala fil�verf�ring anv�nder SRU-filer. Denna PDF/CSV �r ett gransknings- och inmatningsunderlag f�r K4 avsnitt D, inte en SRU-fil.",
    skatteverketGuideTitle: "Var fyller du i detta hos Skatteverket",
    skatteverketGuideHelp: "I Skatteverkets e-tj�nst Inkomstdeklaration 1 l�gger du till bilaga K4 och anv�nder avsnitt D f�r krypto och andra tillg�ngar.",
    skatteverketGuideStep1: "�ppna Inkomstdeklaration 1 och g� till bilagor.",
    skatteverketGuideStep2: "V�lj K4 - �vriga v�rdepapper, andra tillg�ngar m.m.",
    skatteverketGuideStep3: "Anv�nd avsnitt D f�r kryptoavyttringar. Fyll i f�rs�ljningspris och omkostnadsbelopp fr�n rapporten.",
    skatteverketGuideStep4: "Spara den separata inkomstsammanst�llningen som underlag f�r r�nta, staking, rewards och liknande inkomster.",
    skatteverketGuideLink: "�ppna Skatteverkets kryptoguide",
    reportSummary: "Inkomst�r {year} inneh�ller {rows} granskade rader. K4 avsnitt D har {k4Rows} rad{plural} med {profit} vinst och {loss} f�rlust f�re personlig granskning. �vrig inkomst �r {income}.",
    k4Grouped: "K4-avyttringar grupperade per tillg�ng och avyttringsh�ndelse",
    incomeSummary: "Sammanst�llning av �vrig inkomst fr�n r�nta, staking, bonusar och referrals",
    sekTrail: "SEK-v�rderingssp�r med cachade marknads- och valutakurser",
    costBasisMemo: "Anskaffningsv�rdesnotering f�r saknad k�phistorik",
    whatThisMeans: "Vad detta betyder",
    needsReview: "Beh�ver granskas f�re deklaration",
    zeroCostFallbackRows: "{count} avyttringsrader anv�nder konservativt anskaffningsv�rde 0 kr.",
    manualSekPriceRows: "{count} rader beh�ver manuellt SEK-pris",
    incomeRowsIncluded: "{count} inkomstrader ing�r.",
    disposalRowsIncluded: "{count} avyttringsrader ing�r.",
    k4SectionOtherAssets: "K4 avsnitt D - �vriga tillg�ngar",
    k4SectionHelp: "F�r �ver dessa rader till K4 avsnitt D f�r kryptoavyttringar. Vinst och f�rlust h�lls separata s� att de inte nettas f�re inmatning. Digital uppladdning kr�ver SRU-filer.",
    salePrice: "F�rs�ljningspris",
    costBasis: "Omkostnadsbelopp",
    profitLoss: "Vinst / f�rlust",
    noK4Rows: "Inga K4-avyttringsrader f�r valt inkomst�r.",
    date: "Datum",
    source: "K�lla",
    designation: "Beteckning",
    amount: "Antal / belopp",
    proceeds: "F�rs�ljningspris",
    income: "Inkomst",
    status: "Status",
    type: "Typ",
    asset: "Tillg�ng",
    quantity: "Antal",
    otherIncomeNotK4: "�vrig inkomst - inte K4",
    otherIncomeHelp: "R�nta, staking, rewards, referrals och liknande inkomstrader listas separat f�r granskning.",
    otherIncomeDeclarationTitle: "S� anv�nds �vrig inkomst",
    otherIncomeDeclarationHelp: "Detta belopp �r inte ett K4-resultat fr�n avyttring. F�r privat r�nta, staking, earn, rewards och liknande avkastning �r det normala inmatningsst�llet Inkomstdeklaration 1, punkt 7.2 R�nteinkomster, utdelningar m.m.",
    otherIncomeGuideStep1: "�ppna Inkomstdeklaration 1 och v�lj �ndra/l�gg till inkomst under Inkomst av kapital.",
    otherIncomeGuideStep2: "Anv�nd punkt 7.2 R�nteinkomster, utdelningar m.m. f�r privat kryptoavkastning som r�nta, staking, earn, rewards och liknande inkomster.",
    otherIncomeGuideStep3: "Fyll i SEK-summan fr�n rapporten. Spara radlistan som underlag f�r datum, k�lla, coin, antal och SEK-v�rde.",
    otherIncomeGuideStep4: "Anv�nd �vriga upplysningar f�r att beskriva k�lla och typ, till exempel Binance/Abra kryptor�nta eller staking rewards omr�knat till SEK.",
    otherIncomeGuideExceptions: "Anv�nd inte 7.2 om krypton var l�n f�r arbete, n�ringsinkomst eller f�rs�ljning/byte. L�n h�r till tj�nst, n�ringsinkomst till n�ringsverksamhet och f�rs�ljning/byte till K4 avsnitt D.",
    skatteverketDeclarationGuideLink: "�ppna Skatteverkets guide om deklarationens inneh�ll",
    noRows: "Inga rader.",
    signedInUser: "Inloggad anv�ndare",
    working: "Arbetar",
    keepTabOpen: "H�ll fliken �ppen medan server�tg�rden k�rs s�kert.",
    dataOverview: "Data�versikt",
    dataOverviewHelp: "Det som �r inl�st f�r valt inkomst�r.",
    loaded: "Inl�st",
    empty: "Tomt",
    ...
    taxDraftHelp: "Nuvarande resultat f�re personlig granskning.",
    k4Result: "K4-resultat",
    estimatedTax: "Ber�knad skatt",
    rowsReviewed: "Granskade rader",
    openReport: "�ppna rapport",
    pricing: "Priser",
    reviewWorkspace: "Granska importerade rader, SEK-v�rden och rapportunderlag.",
    ...
    useExistingAccount: "Anv�nd befintligt konto",
    createNewAccount: "Skapa nytt konto",
    checkingSignIn: "Kontrollerar inloggning",
    restoringSession: "CryptoTax Sweden �terst�ller din s�kra Supabase-session.",
    switchTheme: "Byt till {theme} tema",
    dark: "M�rkt",
    light: "Ljust",
    transactionCountPricing: "Pris per transaktionsantal",
    transactionCountPricingHelp: "Valt paket baseras p� totalt antal importerade transaktioner i arbetsytan, exklusive moms d�r den betalats.",
    stripe: "Stripe",
    selectedPackage: "Valt paket",
    paidPackagesAdd: "Betalda paket l�ggs ihop upp till {limit} transaktioner. Det valda paketet {plan} l�gger till {slots} platser.",
    paymentState: "Betalningsstatus",
    paymentStateHelp: "�tkomst ges endast efter verifierad Stripe-webhook eller serveravst�mning.",
    ...
    paymentHistoryHelp: "Fakturor h�mtas server-side fr�n Stripe f�r ditt inloggade konto.",
    refresh: "Uppdatera",
    refreshing: "Uppdaterar...",
    refreshInvoicesAfterCheckout: "Uppdatera fakturor efter betalning f�r att se Stripe-l�nkar h�r.",
    fetchingStripeInvoices: "H�mtar Stripe-fakturor...",
    noInvoices: "Inga fakturor hittades �nnu. Slutf�r betalning f�rst.",
    package: "Paket",
    transactionSlots: "Transaktionsplatser",
    total: "Totalt",
    invoice: "Faktura",
    openInvoice: "�ppna faktura",
    waiting: "V�ntar",
    previewReady: "F�rhandsvisning klar",
    selected: "Valda",
    file: "Fil",
    sourceName: "K�lla",
    rowCount: "Rader",
    taxYearWorkspace: "Arbetsyta f�r inkomst�r",
    binanceConnection: "Binance-anslutning",
    binanceConnectionHelp: "Anv�nd din Binance Tax API-nyckel. Uppgifterna skickas bara till Edge Function och lagras krypterat server-side.",
    mainBinance: "Main Binance",
    runDiscovery: "K�r kontroll",
    rerunDiscovery: "K�r kontroll igen",
    importRefreshTransactions: "Importera / uppdatera transaktioner",
    refreshTransactions: "Uppdatera transaktioner",
    connectionSettings: "Anslutningsinst�llningar +",
    csvFallback: "CSV-reserv",
    csvFallbackHelp: "Anv�nd bara om Binance API saknar ett produktomr�de.",
    manual: "Manuell",
    ...
    cancel: "Avbryt",
    keyHint: "Nyckel {key}",
    generateBinanceKeyHelp: "Skapa nyckeln fr�n Binance Tax/API reporting. Radera eller rotera eng�ngsnycklar efter import.",
    importCsvFallbackRows: "Importera CSV-reservrader",
    discovery: "Kontroll",
    discoveryHelp: "Verifiera det anslutna kontot och uppskatta volymen f�r valt inkomst�r f�re import.",
    runFirst: "K�r f�rst",
    noDiscoveryYet: "Ingen kontroll �nnu",
    connectRunDiscoveryForYear: "Anslut Binance och k�r sedan kontroll f�r inkomst�r {year}.",
    discoverySourceForYear: "{source} f�r inkomst�r {year}.",
    noSpotAssets: "Inga spot-tillg�ngar med saldo hittades.",
    more: "till",
    items: "poster",
    sample: "urval",
    coverageCheckHelp: "Detta �r en l�tt kontroll av produktomr�den. Den importerar inte alla produktrader.",
    productCoverage: "Produktomr�den",
    productAreasReturned: "{found}/{checked} produktomr�den gav data",
    connectApiRunDiscovery: "Anslut API-nyckel och k�r kontroll",
    importOtherCsv: "Importera annan CSV",
    optionalWalletCsv: "Valfri CSV fr�n wallet eller b�rs",
    ...
    countApiRows: "R�kna API-rader f�re betalning",
    reviewTaxOutput: "Granska skatteunderlag",
    reportDraftReady: "Rapportutkast klart",
    recoverGenerateK4: "R�kna anskaffningsv�rde och skapa K4-v�rden",
    importedTransactions: "Importerade transaktioner",
    importedTransactionsHelp: "Importerade rader f�r inkomst�r {year}, sorterade p� typ, tillg�ng och datum. Dessa rader anv�nds f�r skatteber�kningen.",
    rowsNeedManualSekPrice: "{count} importerade rader beh�ver manuellt SEK-pris",
    missingPricingOne: "{assets} saknar automatisk priss�ttning.",
    missingPricingMany: "{assets} saknar automatisk priss�ttning.",
    missingPricingSome: "Vissa tillg�ngar saknar automatisk priss�ttning.",
    refreshOrManualPrices: "Uppdatera Binance-importen eller l�gg till manuella priser f�r symboler som inte st�ds.",
    openBinance: "�ppna Binance",
    coin: "Coin",
    all: "Alla",
    allTypes: "Alla typer",
    allCoins: "Alla coins",
    sekPerUnit: "SEK / enhet",
    estValue: "Ber�knat v�rde",
    basisStatus: "Anskaffningsstatus",
    confidence: "S�kerhet",
    csvTransactionImport: "CSV-transaktionsimport",
    csvTransactionImportHelp: "Ladda upp en transaktions-CSV fr�n en annan b�rs eller wallet. AI mappar kolumnerna, sedan godk�nner du importen.",
    csvFile: "CSV-fil",
    analyzeCsv: "Analysera CSV",
    mappingPreview: "Mappningsf�rhandsvisning",
    noCsvAnalyzed: "Ingen CSV analyserad �nnu.",
    mappedRowsSelected: "{selected} av {total} mappade rader valda.",
    noPreview: "Ingen f�rhandsvisning",
    uploadCsvToMap: "Ladda upp en transaktions-CSV f�r att mappa den till skatteunderlaget.",
    rowsToImport: "Rader att importera",
    rowsToImportHelp: "Granska det normaliserade urvalet innan du godk�nner importen.",
    approveImport: "Godk�nn import",
    noRowsYet: "Inga rader �nnu",
    previewRowsHere: "F�rhandsvisningen visar de f�rsta normaliserade raderna h�r.",
    previousCsvImports: "Tidigare CSV-importer",
    previousCsvImportsHelp: "�ppna en import f�r att granska raderna som lades till fr�n filen.",
    noCsvImportsYet: "Inga CSV-importer �nnu",
    approvedCsvImportsAppear: "Godk�nda CSV-importer visas h�r efter att de lagts till i skatteunderlaget.",
    ...
    changeFilters: "�ndra filtren f�r att se andra importerade rader.",
    noImportedTransactions: "Inga importerade transaktioner �nnu",
    runDiscoveryImport: "K�r kontroll och starta transaktionsimport fr�n Binance-sidan.",
    selectVisibleRows: "V�lj synliga rader",
    selectTransaction: "V�lj transaktion",
    actions: "�tg�rder",
    loadMore: "Ladda fler",
    shown: "visas",
    selectedRows: "{count} valda",
    selectAsset: "V�lj {asset}",
    bulkAfterCoin: "Mass�tg�rder �r tillg�ngliga efter att du valt ett coin.",
    selectVisible: "V�lj synliga",
    clear: "Rensa",
    excludeSelected: "Exkludera valda",
    filteredRows: "{count} filtrerade rader",
    transactionActions: "Transaktions�tg�rder",
    edit: "Redigera",
    remove: "Ta bort",
    interest: "R�nta",
    convert: "V�xling",
    transfers: "�verf�ringar",
    trades: "Trades",
    fees: "Avgifter",
    ...
    cryptoTaxHero: "Kryptorapporter f�r svensk deklaration.",
    cryptoTaxLead: "Anslut Binance, importera CSV-filer fr�n andra b�rser eller wallets med AI-mappning, v�rdera varje transaktion i SEK och skapa K4-klart skatteunderlag.",
    binanceApiImport: "Binance API-import",
    ...
    appPreviewAlt: "Inloggad CryptoTax Sweden-arbetsyta med import, transaktioner, betalning och rapportfl�de",
    signedInWorkspaceHelp: "Importera, granska transaktioner och skapa rapporten fr�n en privat arbetsyta.",
    coreStrengths: "Produktens k�rna",
    aiReadsCsv: "AI l�ser ok�nda CSV-exporter",
    aiReadsCsvHelp: "Ladda upp CSV-filer fr�n wallets eller b�rser som Abra. Appen mappar kolumner, klassar rader och v�ntar p� ditt godk�nnande f�re import.",
    sekTrailTitle: "SEK-v�rderingssp�r",
    sekTrailHelp: "Transaktioner v�rderas i SEK med cachade krypto- och valutakurser, och tillg�ngar som inte st�ds flaggas tydligt f�r manuell granskning.",
    k4IncomeApart: "K4 och inkomst h�lls is�r",
    k4IncomeApartHelp: "Avyttringar blir K4 avsnitt D-rader. R�nta, staking, rewards och referrals ligger kvar i en separat inkomstsammanst�llning.",
    workflow: "Arbetsfl�de",
    workflowHeadline: "Fr�n r� export till rapport.",
    pricingHeadline: "Priser.",
    pricingHelp: "Baseras p� totalt antal importerade transaktioner i arbetsytan. Betalda paket visas exklusive moms.",
    secureAccess: "S�ker �tkomst",
    startSecurely: "Kom ig�ng s�kert.",
    ...
    authGateTitle: "Logga in f�r att anv�nda CryptoTax Sweden.",
    authGateHelp: "Binance-anslutningar, importer, rapporter, betalning och kontoinst�llningar �r bara tillg�ngliga efter s�ker Supabase-inloggning.",
    paid: "betald",
    pending: "v�ntar",
  },
};
...
async function hydrateWorkspaceFromDatabase(options = {}) {
  ...
  workspaceHydrationPromise = (async () => {
    try {
      ...
      const [importJobs, dbTransactions, openingBalances, latestReport] = await Promise.all([
      ...
      setState({
        ...
        discovery: discoveryFromImportJobs(importJobs, taxYearRow, normalizedTransactions),
        importPreview: null,
...
function formatTransactionType(type) {
  ...
  const labels = currentLanguage() === "sv"
    ? {
        ...
        deposit: "Ins�ttning",
        withdrawal: "Uttag",
        convert_in: "V�xling in",
        convert_out: "V�xling ut",
        buy: "K�p",
        sell: "S�lj",
        trade: "Trade",
        fee: "Avgift",
      ...
      <table>
        <thead>
          <tr>
            ...
            <th>${currentLanguage() === "sv" ? "F�rlust" : "Loss"}</th>
            <th>${t("status")}</th>
          </tr>
        </thead>
        <tbody>
          ${rows.map((row) => `
            <tr>
              ...
              <td data-label="${currentLanguage() === "sv" ? "F�rlust" : "Loss"}">${row.loss > 0 ? formatReportSek(row.loss) : ""}</td>
